...
![distinct 方法示意图](http://localhost:4000/medias/java/stream_distinct.jpg)
...
![filter 方法示意图](http://localhost:4000/medias/java/stream_filter.jpg)
...
![map 方法示意图](http://localhost:4000/medias/java/stream_map.jpg)
...
![flatMap 方法示意图](http://localhost:4000/medias/java/stream_flatMap.jpg)
...
![peek 方法示意图](http://localhost:4000/medias/java/stream_peek.jpg)
...
![limit 方法示意图](http://localhost:4000/medias/java/stream_limit.jpg)
...
![skip 方法示意图](http://localhost:4000/medias/java/stream_skip.jpg)
...
![reduce 方法示意图](http://localhost:4000/medias/java/stream_reduce.jpg)
